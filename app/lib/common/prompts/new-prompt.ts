...
<technology_preferences>
  ...
  - Use stock photos from Pexels (valid URLs only). Do not download images; link to them instead.
</technology_preferences>
...
<artifact_instructions>
  The assistant may create a SINGLE comprehensive artifact containing:
