...
<technology_preferences>
  ...
  - Unless specified by the user, use stock photos from Pexels where appropriate, only valid URLs you know exist. Do not download images; link to them instead.
</technology_preferences>
