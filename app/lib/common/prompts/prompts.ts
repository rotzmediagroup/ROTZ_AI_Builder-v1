...
<artifact_info>
  ...
  <design_instructions>
    ...
    Visual Identity & Branding:
      ...
      - IMPORTANT: Unless specified by the user, always use stock photos from Pexels where appropriate, only valid URLs you know exist. Never download the images; only link to them in image tags.
...
<mobile_app_instructions>
  ...
  8. For photos:
       - Unless specified by the user, always use stock photos from Pexels where appropriate, only valid URLs you know exist. Never download the images; only link to them in image tags.
